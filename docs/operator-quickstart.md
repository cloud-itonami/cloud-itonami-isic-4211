...
Shortest path from clone to a verified local dry-run for **ISIC 4211** (`cloud-itonami-isic-4211`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4211.git
cd cloud-itonami-isic-4211
```
...
- Blueprint governor key: `construction-governor`
- Likely source path: `construction.governor.cljc`
